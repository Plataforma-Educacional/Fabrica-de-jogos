...
export const gameApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        createAnagram: builder.mutation<gameState<anagramOptions>, Partial<gameState<anagramOptions>>>({
        ...
        createMatchUp: builder.mutation<gameState<matchUpOptions>, Partial<gameState<matchUpOptions>>>({
        ...
        createQuiz: builder.mutation<gameState<quizOptions>, Partial<gameState<quizOptions>>>({
        ...
        // True or false
        getTrueOrFalseBySlug: builder.query<gameState<trueOrFalseOptions>, string>({
            query: (slug) => `/true-or-false/${slug}`,
        }),
        createTrueOrFalse: builder.mutation<gameState<trueOrFalseOptions>, Partial<gameState<trueOrFalseOptions>>>({
        ...
        updateTrueOrFalse: builder.mutation<
            ...
            Partial<gameState<trueOrFalseOptions>> & Pick<gameState<trueOrFalseOptions>, 'slug'>
        >({
            query: ({ slug, ...body }) => ({
        ...
        // Word-Search
        getWordSearchBySlug: builder.query<gameState<wordSearchOptions>, string>({
            query: (slug) => `/word-search/${slug}`,
        }),
        createWordSearch: builder.mutation<gameState<wordSearchOptions>, Partial<gameState<wordSearchOptions>>>({
        ...
        updateWordSearch: builder.mutation<
            ...
            Partial<gameState<wordSearchOptions>> & Pick<gameState<wordSearchOptions>, 'slug'>
        >({
            query: ({ slug, ...body }) => ({
        ...
        // Memory-Game
        getMemoryGameBySlug: builder.query<gameState<memoryGameOptions>, string>({
            query: (slug) => `/memory-game/${slug}`,
        }),
        createMemoryGame: builder.mutation<gameState<memoryGameOptions>, FormData>({
            query: (body: FormData) => ({
                url: '/memory-game',
                method: 'POST',
                body: body,
        ...
        updateMemoryGame: builder.mutation<gameState<memoryGameOptions>, updateMemoryGameInput>({
            query: ({ slug, data }) => ({
        ...
        createGroupSort: builder.mutation<gameState<groupSortOptions>, Partial<gameState<groupSortOptions>>>({
        ...
        updateGroupSort: builder.mutation<
            ...
            Partial<gameState<groupSortOptions>> & Pick<gameState<groupSortOptions>, 'slug'>
        >({
            query: ({ slug, ...body }) => ({
                url: `group-sort/${slug}`,
                method: 'PUT',
        ...
        createBalloons: builder.mutation<gameState<balloonOptions>, Partial<gameState<balloonOptions>>>({
        ...
        // Cryptogram
        getCryptogramBySlug: builder.query<gameState<cryptogramOptions>, string>({
            query: (slug) => `cryptogram/${slug}`,
        }),
        createCryptogram: builder.mutation<gameState<cryptogramOptions>, Partial<gameState<cryptogramOptions>>>({
        ...
        updateCryptogram: builder.mutation<
            ...
            Partial<gameState<cryptogramOptions>> & Pick<gameState<cryptogramOptions>, 'slug'>
        >({
            query: ({ slug, ...body }) => ({
                url: `cryptogram/${slug}`,
                method: 'PUT',
        ...
        createDragNDrop: builder.mutation<gameState<number[]>, Partial<gameState<number[]>>>({
        ...
        createPuzzle: builder.mutation<gameState<number[]>, Partial<gameState<number[]>>>({
            query: (body: gameState<number[]>) => ({
                url: '/puzzle',
                method: 'POST',
                body: body,
